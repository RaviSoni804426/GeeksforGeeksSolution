<h2><a href="https://www.geeksforgeeks.org/problems/count-pairs-with-given-sum--150253/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Count pairs with given sum</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an array <strong>arr[]</strong> and an integer <strong>target</strong>. You have to count all pairs in the array such that their sum is equal to the given <strong>target</strong>.</span></p>
